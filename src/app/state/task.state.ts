...
// Class definition of error field
...
export class TasksState {
    ...
    // Function handling how state is updated when action is triggered
    @Action(AppError)
    setAppError(
